...
class AIAssistant {
    constructor() {
        ...
        this.SITE_NAME = 'Crona - Удаление деревьев';
        
        // Системный промпт для главной страницы
        this.SYSTEM_PROMPT = `Вы - ИИ-ассистент компании Crona, профессиональной арбористической компании, специализирующейся на удалении деревьев в Санкт-Петербурге и Ленинградской области.

=== О КОМПАНИИ CRONA ===
Компания Crona - профессионалы в области арбористики и удаления деревьев в СПб и ЛО
Основные услуги: удаление деревьев, спил деревьев частями, такелажные работы, удаление аварийных деревьев
        ...
        try {
            const response = await fetch(url, {
                ...
                headers: {
                    ...
                    'X-Title': 'Crona - Удаление деревьев'
                },
