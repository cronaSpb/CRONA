...
- Если не знаете ответ - предложите связаться с менеджером по телефону`;
    ...
    async getAIResponseDirect() {
        ...
        if (userMessage.includes('привет') || userMessage.includes('здравствуй')) {
            return 'Здравствуйте! Я ИИ-ассистент Лесного кода от Crona. Готов ответить на вопросы об уходе за лесными растениями в северо-западном регионе. Чем могу помочь?';
        }
        
        if (userMessage.includes('услуг') || userMessage.includes('цен') || userMessage.includes('стоимость')) {
            return 'Мы предлагаем комплексные услуги по уходу за лесными растениями: кронирование, посадка, пересадка, стабилизация, рекультивация. Для точного расчета стоимости и консультации звоните: +7 (953) 372-53-87 или пишите на E-mail@crona-spb.com';
        }
        
        if (userMessage.includes('контакт') || userMessage.includes('телефон') || userMessage.includes('адрес')) {
            return 'Наши контакты: Телефон: +7 (953) 372-53-87, Email: E-mail@crona-spb.com, Сайт: https://bio-plus.ru. Работаем по Санкт-Петербургу и Ленинградской области.';
        }
        
        if (userMessage.includes('кронирование') || userMessage.includes('обрезк')) {
            return 'Кронирование - это формирование кроны деревьев для их здоровья и безопасности. Мы профессионально выполняем кронирование различных пород деревьев в северо-западном регионе. Для заказа услуг звоните: +7 (953) 372-53-87';
        }
        
        // Базовый ответ для остальных случаев
        return 'Спасибо за вопрос! Я ИИ-ассистент Лесного кода от Crona. Мы профессионально занимаемся уходом за лесными растениями в северо-западном регионе. Для консультации или заказа услуг звоните: +7 (953) 372-53-87 или пишите на E-mail@crona-spb.com. Сайт: https://bio-plus.ru';
    }
